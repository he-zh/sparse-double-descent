...
from pruning.magnitude import Strategy
from pruning.magnitude import PruningHparams
from testing import test_case


class TestMagnitude(test_case.TestCase):
    def setUp(self):
        super(TestMagnitude, self).setUp()
        self.hparams_global = PruningHparams('magnitude', pruning_fraction=0.2)
        self.hparams_layer = PruningHparams('magnitude', pruning_fraction=0.2, pruning_scope='layer')
    ...
    def test_globally_prune(self):
        ...
        self.assertGreater(self.hparams_global.pruning_fraction + 0.0001, actual_fraction)
