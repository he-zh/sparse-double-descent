...
@dataclass
class ScratchDesc(Desc):
    """The hyperparameters necessary to describe a pruning and retraining from re-initialized scratch backbone."""
    ...
    @staticmethod
    def name_prefix(): return 'scratch'
    ...
    @staticmethod
    def add_args(parser: argparse.ArgumentParser, defaults: 'ScratchDesc' = None):
        ...
        ScratchDesc._add_pretrain_argument(pretraining_parser)
    ...
    @classmethod
    def create_from_args(cls, args: argparse.Namespace) -> 'ScratchDesc':
